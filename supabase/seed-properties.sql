...
insert into public.properties
 (reference, slug, title, short_description, description, operation, property_type, price,
  location, province, zone, address, bedrooms, bathrooms, area, plot_area,
  features, images, image_fallback, source_url, featured, status, availability, agent_name, agent_phone, published_at)
 values ('f0-9f-94-91fantastico-chalet-en-venta-con-todas-las-calidades-y-comodidades-en-ecija-sevilla-f0-9f-94-91', '%f0%9f%94%91fantastico-chalet-en-venta-con-todas-las-calidades-y-comodidades-en-ecija-sevilla-%f0%9f%94%91', 'Fántastico chalet en venta con todas las calidades y comodidades en Écija (Sevilla)', '', 'BAJADA DE PRECIO',
...
insert into public.properties
 (reference, slug, title, short_description, description, operation, property_type, price,
  location, province, zone, address, bedrooms, bathrooms, area, plot_area,
  features, images, image_fallback, source_url, featured, status, availability, agent_name, agent_phone, published_at)
 values ('f0-9f-94-91casa-para-derribar-en-zona-centro-ecija-sevilla-f0-9f-94-91', '%f0%9f%94%91casa-para-derribar-en-zona-centro-ecija-sevilla-%f0%9f%94%91', 'Casa para derribar en zona centro, Écija (Sevilla)', '', '✴EXCLUSIVIDAD✴ 🔑CASA PARA DERRIBAR EN ZONA CENTRO, ECIJA (SEVILLA) 🔑 💵Precio: 110.000€💵 ✅ Inmobiliaria Noguera vende casa para derribar en zona centro. ✅Esta espaciosa vivienda en Écija se encuentra en venta. Con una superficie total de 250 m². Se encuentra para derribar, lo que brinda la oportunidad de adaptarla completamente a tus gustos y necesidades. ✅Ubicada en el municipio de Écija, esta propiedad ofrece un gran potencial para convertirse en el hogar de tus sueños. ¡No dejes pasar esta oportunidad única! ➡ Casa en el Centro ➡ Vivienda de RENTA LIBRE ➡ Ref. : 8635 💵Precio: 110.000€💵 Para más información no dude en contactar con nosotros: ****** En cumplimiento del Decreto de la Junta de Andalucía 218/2005 del 11 de Octubre, el Impuesto de Transmisiones Patrimoniales ó IVA, los gastos de Notaría y Registro regulados por arancel no están incluidos en el precio. Los honorarios profesionales de la Agencia no están incluidos. Validez de precios 7 días, sujeto a disponibilidades y confirmación por propietarios. Se considera que la descripción y los precios indicados para las propiedades a la venta en este sitio web son correctos. No obstante, la información que contiene esta página puede ser sujeta a errores u omisiones. Las propiedades pueden ser sujetas a cambio de precio, venta o retirada del mercado #oportunidad #ecija #centrodeEcija #inmobiliarianoguera #pisos #inmobiliaria #piso #casa #adosada #pisoconpatio #idealista #fotocasa #oportunidad #ecija #centrodeEcija #inmobiliarianoguera #pisos #inmobiliaria #piso #casa #adosada #pisoconpatio #idealista #fotocasa',
...
insert into public.properties
 (reference, slug, title, short_description, description, operation, property_type, price,
  location, province, zone, address, bedrooms, bathrooms, area, plot_area,
  features, images, image_fallback, source_url, featured, status, availability, agent_name, agent_phone, published_at)
 values ('se-alquila-edificio-completo-en-en-avd-miguel-de-cervantes-antigua-sucursal-de-unicaja-ecijasevilla-2', 'se-alquila-edificio-completo-en-en-avd-miguel-de-cervantes-antigua-sucursal-de-unicaja-ecijasevilla-2', 'Se alquila edificio completo en en Avda. miguel de cervantes (antigua sucursal de unicaja (Écija,Sevilla)', '', 'SE ALQUILA EDIFICIO COMPLETO EN EN AVD. MIGUEL DE CERVANTES (ANTIGUA SUCURSAL DE UNICAJA (ECIJA,SEVILLA)',
...
insert into public.properties
 (reference, slug, title, short_description, description, operation, property_type, price,
  location, province, zone, address, bedrooms, bathrooms, area, plot_area,
  features, images, image_fallback, source_url, featured, status, availability, agent_name, agent_phone, published_at)
 values ('se-alquila-edificio-completo-en-en-avd-miguel-de-cervantes-antigua-sucursal-de-unicaja-ecijasevilla', 'se-alquila-edificio-completo-en-en-avd-miguel-de-cervantes-antigua-sucursal-de-unicaja-ecijasevilla', 'Se alquila edificio completo en en Avda. miguel de cervantes (antigua sucursal de unicaja (Écija,Sevilla)', '', 'SE ALQUILA EDIFICIO COMPLETO EN EN AVD. MIGUEL DE CERVANTES (ANTIGUA SUCURSAL DE UNICAJA (ECIJA,SEVILLA)',
  'alquiler', 'piso', 1900, 'Écija', 'Sevilla', 'Écija', 'Écija',
  null, 2, 300, null,
...
insert into public.properties
 (reference, slug, title, short_description, description, operation, property_type, price,
  location, province, zone, address, bedrooms, bathrooms, area, plot_area,
  features, images, image_fallback, source_url, featured, status, availability, agent_name, agent_phone, published_at)
 values ('f0-9f-92-a5casa-en-venta-zona-el-ferrocarril-ecija-sevilla-f0-9f-92-a5', '%f0%9f%92%a5casa-en-venta-zona-el-ferrocarril-ecija-sevilla-%f0%9f%92%a5', 'Casa en venta zona el ferrocarril Écija (Sevilla)', '', 'EXCLUSIVIDAD',
  'venta', 'casa', 150000, 'Écija', 'Sevilla', 'Écija', 'Écija',
  3, 2, 220, null,
...
insert into public.properties
 (reference, slug, title, short_description, description, operation, property_type, price,
  location, province, zone, address, bedrooms, bathrooms, area, plot_area,
  features, images, image_fallback, source_url, featured, status, availability, agent_name, agent_phone, published_at)
 values ('f0-9f-94-91piso-de-renta-libre-con-garaje-y-ascensor-en-ecija-sevilla-f0-9f-94-91', '%f0%9f%94%91piso-de-renta-libre-con-garaje-y-ascensor-en-ecija-sevilla-%f0%9f%94%91', 'Piso de renta libre con garaje y ascensor en Écija (Sevilla)', '', 'EXCLUSIVIDAD',
...
insert into public.properties
 (reference, slug, title, short_description, description, operation, property_type, price,
  location, province, zone, address, bedrooms, bathrooms, area, plot_area,
  features, images, image_fallback, source_url, featured, status, availability, agent_name, agent_phone, published_at)
 values ('f0-9f-93-8d-apartamento-en-venta-en-puerta-cerrada-ecija-sevilla-f0-9f-93-8d', '%f0%9f%93%8d-apartamento-en-venta-en-puerta-cerrada-ecija-sevilla-%f0%9f%93%8d', 'Apartamento en venta en puerta cerrada, Écija (Sevilla)', '', '✴ EXCLUSIVIDAD ✴💵 Precio: 107.000€ 💵 📍 APARTAMENTO EN VENTA EN PUERTA CERRADA, ECIJA (SEVILLA) 📍 ✅ Inmobiliaria Noguera vende este apartamento situada en la C/Carreras, zona de Puerta Cerrada, Écija (Sevilla) ✅ Este acogedor apartamento en venta en Écija ofrece una superficie total de 47m2. Dispone de una vivienda interior con un salón comedor, cocina equipada, habitación doble con un gran armario empotrado y un baño completo con plato de ducha, ideal para personas o parejas que buscan confort y funcionalidad. El apartamento se encuentra en buen estado de conservación, listo para ser habitado sin necesidad de reformas. Un detalle destacado es el patio interior y privado que permite la entrada de luz natural y ventilación, mejorando la calidad del ambiente interior. ✅ Esta propiedad es una oportunidad atractiva en Écija para quienes buscan un hogar funcional y cómodo. OBSERVACIONES: ➡ PATIO ➡ RENTA LIBRE ➡ PLANTA BAJA ➡ EXCELENTE UBICACION ➡ Ref. : 8674 💵 Precio: 107.000€ 💵 Para más información no dude en contactar con nosotros: ****** En cumplimiento del Decreto de la Junta de Andalucía 218/2005 del 11 de Octubre, el Impuesto de Transmisiones Patrimoniales ó IVA, los gastos de Notaría y Registro regulados por arancel no están incluidos en el precio. Los honorarios profesionales de la Agencia no están incluidos. Validez de precios 7 días, sujeto a disponibilidades y confirmación por propietarios. Se considera que la descripción y los precios indicados para las propiedades a la venta en este sitio web son correctos. No obstante, la información que contiene esta página puede ser sujeta a errores u omisiones. Las propiedades pueden ser sujetas a cambio de precio, venta o retirada del mercado #oportunidad #ecija #centrodeEcija #inmobiliarianoguera #pisos #inmobiliaria #piso #casa #adosada #pisoconpatio #idealista #fotocasa #oportunidad #ecija #centrodeEcija #inmobiliarianoguera #pisos #inmobiliaria #piso #casa #adosada #pisoconpatio #idealista #fotocasa',
...
insert into public.properties
 (reference, slug, title, short_description, description, operation, property_type, price,
  location, province, zone, address, bedrooms, bathrooms, area, plot_area,
  features, images, image_fallback, source_url, featured, status, availability, agent_name, agent_phone, published_at)
 values ('f0-9f-94-91casa-de-pueblo-en-venta-ecija-sevilla-f0-9f-94-91', '%f0%9f%94%91casa-de-pueblo-en-venta-ecija-sevilla-%f0%9f%94%91', 'Casa de pueblo en venta. Écija (Sevilla)', '', 'EXCLUSIVIDAD',
...
insert into public.properties
 (reference, slug, title, short_description, description, operation, property_type, price,
  location, province, zone, address, bedrooms, bathrooms, area, plot_area,
  features, images, image_fallback, source_url, featured, status, availability, agent_name, agent_phone, published_at)
 values ('f0-9f-93-8d-casa-amueblada-en-la-luisiana-sevilla-f0-9f-93-8d', '%f0%9f%93%8d-casa-amueblada-en-la-luisiana-sevilla-%f0%9f%93%8d', 'Casa amueblada en la luisiana (Sevilla)', '', 'EXCLUSIVIDAD',
...
insert into public.properties
 (reference, slug, title, short_description, description, operation, property_type, price,
  location, province, zone, address, bedrooms, bathrooms, area, plot_area,
  features, images, image_fallback, source_url, featured, status, availability, agent_name, agent_phone, published_at)
 values ('f0-9f-93-8dsolar-en-zona-centro-ecija-sevilla-f0-9f-93-8d', '%f0%9f%93%8dsolar-en-zona-centro-ecija-sevilla%f0%9f%93%8d', 'Solar en zona centro, Écija, Sevilla', '', 'EXCLUSIVIDAD Precio: 99.000€',
...
insert into public.properties
 (reference, slug, title, short_description, description, operation, property_type, price,
  location, province, zone, address, bedrooms, bathrooms, area, plot_area,
  features, images, image_fallback, source_url, featured, status, availability, agent_name, agent_phone, published_at)
 values ('f0-9f-93-8dcasa-en-venta-en-la-alcarrachela-ecija-sevilla-f0-9f-93-8d', '%f0%9f%93%8dcasa-en-venta-en-la-alcarrachela-ecija-sevilla%f0%9f%93%8d', 'Casa en venta en la alcarrachela- Écija (Sevilla)', '', 'EXCLUSIVIDAD Precio: 230.000€',
...
insert into public.properties
 (reference, slug, title, short_description, description, operation, property_type, price,
  location, province, zone, address, bedrooms, bathrooms, area, plot_area,
  features, images, image_fallback, source_url, featured, status, availability, agent_name, agent_phone, published_at)
 values ('f0-9f-94-91piso-en-venta-en-ecija-sevilla-f0-9f-94-91', '%f0%9f%94%91piso-en-venta-en-ecija-sevilla%f0%9f%94%91', 'Piso en venta en Écija (Sevilla)', '', 'EXCLUSIVIDAD',
...
insert into public.properties
 (reference, slug, title, short_description, description, operation, property_type, price,
  location, province, zone, address, bedrooms, bathrooms, area, plot_area,
  features, images, image_fallback, source_url, featured, status, availability, agent_name, agent_phone, published_at)
 values ('f0-9f-93-8d-plaza-de-garaje-cerrada-en-zona-puerta-palma-sevilla-f0-9f-93-8d', '%f0%9f%93%8d-plaza-de-garaje-cerrada-en-zona-puerta-palma-sevilla-%f0%9f%93%8d', 'Plaza de garaje cerrada en zona puerta palma (Sevilla)', '', 'EXCLUSIVIDAD Precio: 15.000€',
...
insert into public.properties
 (reference, slug, title, short_description, description, operation, property_type, price,
  location, province, zone, address, bedrooms, bathrooms, area, plot_area,
  features, images, image_fallback, source_url, featured, status, availability, agent_name, agent_phone, published_at)
 values ('f0-9f-93-8d-piso-en-venta-en-zona-los-miradores-ecija-sevilla-f0-9f-93-8d', '%f0%9f%93%8d-piso-en-venta-en-zona-los-miradores-ecija-sevilla-%f0%9f%93%8d', 'Piso en venta en zona los miradores, Écija (Sevilla)', '', 'EXCLUSIVIDAD Precio: 130.000€',
  'venta', 'piso', 130000, 'Écija', 'Sevilla', 'Écija', 'Écija',
  3, 2, 92, null,
...
insert into public.properties
 (reference, slug, title, short_description, description, operation, property_type, price,
  location, province, zone, address, bedrooms, bathrooms, area, plot_area,
  features, images, image_fallback, source_url, featured, status, availability, agent_name, agent_phone, published_at)
 values ('f0-9f-93-8d-casa-totalmente-reformada-en-la-luisiana-f0-9f-93-8d', '%f0%9f%93%8d-casa-totalmente-reformada-en-la-luisiana-%f0%9f%93%8d', 'Casa totalmente reformada en la luisiana', '', 'EXCLUSIVIDAD',
